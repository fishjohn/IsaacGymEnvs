...
class BipedAMPBase(VecTask):
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        rigid_shape_prop = self.gym.get_asset_rigid_shape_properties(biped_asset)
        ...
        for i in range(self.num_envs):
            ...
            self.gym.set_asset_rigid_shape_properties(biped_asset, rigid_shape_prop)
            biped_handle = self.gym.create_actor(env_handle, biped_asset, start_pose, "biped", i, 0, 0)
            self.gym.set_actor_dof_properties(env_handle, biped_handle, dof_props)
